...
public class Constant {
    ...
    public static final String CLARIFAI_CLIENT_SECRET="DtSKchdpNCv6OhfLWFsbMEbuKMB2ZjKYMCt8AVoE";
    ...
    public static final String EIGHTBIT_APIKEY="a6487c94-4a41-4981-b1d7-f2dfdc1aa8fc";

    public static final String CLOUDINARY_APIKEY="149862837211897";
    public static final String CLOUDINARY_SECRETKEY="IRnvKPliYzQ0U8rmBjYR3_No_ow";
